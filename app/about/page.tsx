...
const page = () => {
  return (
    <>
    <Header/>
    <section className=" bg-gray-900 text-white py-20 px-6 !w-screen overflow-hidden">
  {/* Content goes here */}
  ...
  <motion.div
    className="max-w-6xl m-auto mb-20 grid grid-cols-1 md:grid-cols-2 gap-12"
  ...
  >
    ...
    >
      <img
        src="/IDK01.webp"
        alt="Our Mission"
        className="w-full h-full object-contain rounded-lg shadow-lg max-w-full" 
      />
    </motion.div>
  </motion.div>
